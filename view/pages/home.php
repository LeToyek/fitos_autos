...
<body>
  ...
  <div class="container-fluid px-5 main">
    <div class="row h-100">
      <div class="col-lg-12 w-100 jumbotron">
      </div>
    </div>
      ...
      <div class="top d-flex align-center">
        ...
        <a href="./garage.html">
          <img src="../icons/right-arrow.png"
            style="margin-left: 8px; margin-bottom: 4px; width: 16px; cursor: pointer;" alt="">
        </a>
      </div>
  ...
  <footer class="container">
    ...
    <p class="mt-2">Portal E-Commerce Mobil yang terintegrasi <br>dan terbesar di Asia Tenggara. Hadir di <br> Malaysia, Indonesia,
      Thailand, dan Singapura</p>
  ...
  <h6 class="copyright mb-3">© 2016-2022 PT Fitos Autos Dilindungi oleh hak cipta</h6>
</body>
