...
<body>
  ...
  <form class="needs-validation container p-5 mt-5" enctype="multipart/form-data"
    action="../../controller/form_jual_process.php" method="POST" novalidate>
    <div class="statis" style="margin-bottom: 24px;">
      <div class="title mb-2">
        <h4 class="mr-2">Formulir Penjualan Mobil</h4>
    ...
    <div class="form-row mt-2">
      <div class="form-group col-md-8">
        ...
        <input name="nama" type="text" class="form-control" id="validationCustom01" placeholder="Nama"
          value="<?php echo (isset($_COOKIE['nama'])) ? $_COOKIE['nama'] : ''?>" required />
        <div class="invalid-feedback">Nama Harus diisi</div>
      </div>
      <div class="form-group col-md-4">
        <label>Merk Mobil</label>
        <input name="merk" type="text" class="form-control" id="inputPassword4" placeholder="Merk"
          value="<?php echo (isset($_COOKIE['merk'])) ? $_COOKIE['merk'] : ''?>" required />
    ...
    <div class="form-group mt-2">
      ...
      <div class="input-group">
        ...
        <input type="text" name="price" class="form-control" id="inlineFormInputGroupUsername" placeholder="10000000"
          required value="<?php echo (isset($_COOKIE['harga'])) ? $_COOKIE['harga'] : ''?>" />
    ...
    <div class="form-group mt-2 d-flex flex-column">
      ...
      <input type="file" name="foto" class="w-25" id="formFileSm" required />
    ...
    <div class="form-group mt-2">
      ...
      <textarea name="deskripsi" class="form-control" id="exampleFormControlTextarea1" rows="3"
        value="<?php echo (isset($_COOKIE['deskripsi'])) ? $_COOKIE['deskripsi'] : ''?>"></textarea>
    </div>
    <div class="form-group mt-2">
      <label for="inputEmail4">Alamat</label>
      <input name="alamat" type="text" class="form-control" id="inputEmail4" placeholder="Alamat"
        value="<?php echo (isset($_COOKIE['alamat'])) ? $_COOKIE['alamat'] : ''?>" required />
    ...
    <div class="form-row">
      ...
      <div class="form-group mt-2 col-md-4">
        ...
        <input name="kilometer" type="text" class="form-control" id="validationCustom02" placeholder="1999"
          value="<?php echo (isset($_COOKIE['kilometer'])) ? $_COOKIE['kilometer'] : ''?>" required />
    ...
    <div class="form-group mt-2">
      <div class="form-check">
        ...
        <div class="mt-2">
          ...
          <label class="form-check-label" for="gridApprove"> Saya setuju dengan syarat dan ketentuan yang berlaku
          </label>
        </div>
